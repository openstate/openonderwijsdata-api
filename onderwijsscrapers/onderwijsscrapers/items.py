...
class DuoMboInstitution(Item):
    ...
    name = Field()
    nodal_area = Field()
    nodal_area_code = Field()
    education_area = Field()
    education_area_code = Field()
    rpa_area = Field()
    rpa_area_code = Field()
    rmc_region = Field()
    rmc_region_code = Field()
    phone = Field()
    website = Field()
    wgr_area = Field()
    wgr_area_code = Field()
    mbo_institution_kind = Field()
    mbo_institution_kind_code = Field()
